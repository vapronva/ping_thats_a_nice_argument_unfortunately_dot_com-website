...
! function (e) {
  ...
  return function e(t, n, o) {
        ...
        o.set = function (e, t, n) {
          ...
          for (var n = 0; n < e.parts.length; n++) {
            ...
            o.isStatic = t, t ? (o._original = {
              ...
              }, o.restitution = 0, o.friction = 1, o.mass = o.inertia = o.density = 1 / 0, o.inverseMass = o.inverseInertia = 0, o.positionPrev.x = o.position.x, o.positionPrev.y = o.position.y, o.anglePrev = o.angle, o.angularVelocity = 0, o.speed = 0, o.angularSpeed = 0,
              o.motion = 0) : o._original && (o.restitution = o._original.restitution, o.friction = o._original.friction, o.mass = o._original.mass, o.inertia = o._original.inertia, o.density = o._original.density, o.inverseMass = o._original.inverseMass, o.inverseInertia = o._original.inverseInertia, o._original = null)
          }
          ...
          var r;
          for (t = t.slice(0), e.parts.length = 0,
            e.parts.push(e), e.parent = e, r = 0; r < t.length; r++) {
            var s = t[r];
          ...
          e.anglePrev = e.angle - t, e.angularVelocity = t, e.angularSpeed = Matter.Common.abs(e.angularVelocity)
        }, o.translate = function (e, t) {
          o.setPosition(e, r.add(e.position, t))
        }, o.rotate = function (e, t, n) {
          if (n) {
            var i = Matter.Common.cos(t),
              r = Matter.Common.sin(t),
              s = e.position.x - n.x,
              a = e.position.y - n.y;
            o.setPosition(e, {
              x: n.x + (s * i - a * r),
          ...
          e.velocity.x = d * a * o + e.force.x / e.mass * s, e.velocity.y = u * a * o + e.force.y / e.mass * s, e.positionPrev.x = e.position.x, e.positionPrev.y = e.position.y, e.position.x += e.velocity.x, e.position.y += e.velocity.y, e.angularVelocity = (e.angle - e.anglePrev) * a * o + e.torque / e.inertia * s, e.anglePrev = e.angle, e.angle += e.angularVelocity, e.speed = r.magnitude(e.velocity), e.angularSpeed = Matter.Common.abs(e.angularVelocity);
          for (var p = 0; p < e.parts.length; p++) {
            var f = e.parts[p];
            i.translate(f.vertices, e.velocity), p > 0 && (f.position.x += e.velocity.x, f.position.y += e.velocity.y),
              0 !== e.angularVelocity && (i.rotate(f.vertices, e.angularVelocity, e.position), c.rotate(f.axes, e.angularVelocity), p > 0 && r.rotateAbout(f.position, e.angularVelocity, e.position, f.position)), l.update(f.bounds, f.vertices, e.velocity)
          }
          ...
          for (var t = {
            ...
            t.mass += i, t.area += o.area, t.inertia += o.inertia, t.centre = r.add(t.centre, r.mult(o.position, o.mass !== 1 / 0 ? o.mass : 1))
          }
      ...
      ! function () {
        o.create = function (e) {
          ...
          o.removeBodyAt = function (e, t) {
            ...
            for (var r = Matter.Common.cos(t), s = Matter.Common.sin(t), l = i ? o.allBodies(e) : e.bodies, c = 0; c < l.length; c++) {
              var d = l[c],
                u = d.position.x - n.x,
                p = d.position.y - n.y;
              a.setPosition(d, {
      ...
      t.exports = o,
        function () {
          o.create = function (e, t) {
            ...
            return o.update(r, e, t), r
          }, o.update = function (e, t, n) {
            if (e.collision = t, t.collided) {
              var i = t.supports,
                r = e.activeContacts,
                s = t.parentA,
                a = t.parentB;
              e.inverseMass = s.inverseMass + a.inverseMass, e.friction = Math.min(s.friction, a.friction), e.frictionStatic = Math.max(s.frictionStatic, a.frictionStatic), e.restitution = Math.max(s.restitution, a.restitution), e.slop = Math.max(s.slop, a.slop);
              for (var l = 0; l < i.length; l++) r[l] = i[l].contact;
              var c = i.length;
              c < r.length && (r.length = c), e.separation = t.depth, o.setActive(e, !0, n)
    ...
    7: [function (e, t, n) {
      ...
      ! function () {
        o._pairMaxIdleLife = 1e3, o.create = function (e) {
          ...
          var o, r, s, a, l = e.list,
            c = e.table,
            d = e.collisionStart,
            u = e.collisionEnd,
            p = e.collisionActive;
          for (d.length = 0, u.length = 0, p.length = 0, a = 0; a < l.length; a++) l[a].confirmedActive = !1;
          for (a = 0; a < t.length; a++) o = t[a], o.collided && (r = i.id(o.bodyA, o.bodyB), s = c[r], s ? (s.isActive ? p.push(s) : d.push(s), i.update(s, o, n), s.confirmedActive = !0) : (s = i.create(o, n), c[r] = s, d.push(s), l.push(s)));
          for (a = 0; a < l.length; a++) s = l[a], s.isActive && !s.confirmedActive && (i.setActive(s, !1, n), u.push(s))
    ...
    9: [function (e, t, n) {
      ...
      ! function () {
        o._restingThresh = 4, o._restingThreshTangent = 6, o._positionDampen = .9, o._positionWarming = .8, o._frictionNormalMultiplier = 5, o.preSolvePosition = function (e) {
          var t, n, o;
          for (t = 0; t < e.length; t++) n = e[t], n.isActive && (o = n.activeContacts.length, n.collision.parentA.totalContacts += o,
            n.collision.parentB.totalContacts += o)
        }, o.solvePosition = function (e, t, n) {
          var i, r, s, a, l, c, d, u, p, f, m, v, y, g, x, h, b = n * o._positionDampen;
          for (i = 0; i < t.length; i++) {
            var w = t[i];
            w.previousPositionImpulse.x = w.positionImpulse.x, w.previousPositionImpulse.y = w.positionImpulse.y
          }
          for (i = 0; i < e.length; i++) a = e[i], a.isActive && !a.isSensor && (l = a.collision, c = l.parentA, d = l.parentB, u = l.normal, m = c.previousPositionImpulse, v = d.previousPositionImpulse, f = l.penetration, g = v.x - m.x + f.x, x = v.y - m.y + f.y, r = u.x, s = u.y, p = r * g + s * x, a.separation = p, a.separation < 0 || (h = (p - a.slop) * b, (c.isStatic || d.isStatic) && (h *= 2), c.isStatic || c.isSleeping || (y = h / c.totalContacts, c.positionImpulse.x += r * y, c.positionImpulse.y += s * y), d.isStatic || d.isSleeping || (y = h / d.totalContacts, d.positionImpulse.x -= r * y, d.positionImpulse.y -= s * y)))
      ...
      ! function () {
        o.create = function (e, t) {
          ...
          for (l.update(h, x, b), l.removeOld(h, b), e.enableSleeping && r.afterCollisions(h.list, c.timeScale),
            ...
            }), s.preSolvePosition(h.list), i = 0; i < e.positionIterations; i++) s.solvePosition(h.list, y, c.timeScale);
    ...
    19: [function (e, t, n) {
      ...
      var i = e("./Common");
      ! function () {
        o._registry = {}, o._forKey = "for", o.register = function (e) {
          ...
          var n = e[o._forKey] && o.dependencyParse(e[o._forKey]);
          return !e[o._forKey] || t.name === n.name && o.versionSatisfies(t.version, n.range)
        }, o.use = function (e, t) {
          ...
          for (var n = o.dependencies(e), r = i.topologicalSort(n), s = [], a = 0; a < r.length; a += 1)
            if (r[a] !== e.name) {
              var l = o.resolve(r[a]);
              l ? o.isUsed(e, l.name) || (o.isFor(l, e) || (i.warn("Plugin.use:", o.toString(l), "is for", l[o._forKey], "but installed on", o.toString(e) + "."), l._warned = !0), l.install ? l.install(e) : (i.warn("Plugin.use:", o.toString(l), "does not specify an install function."), l._warned = !0), l._warned ? (s.push("🔶 " + o.toString(l)), delete l._warned) : s.push("✅ " + o.toString(l)), e.used.push(l.name)) : s.push("❌ " + r[a])
      ...
      ! function () {
        o.rectangle = function (e, t, n, o, i) {
          ...
          for (var c = 2 * Math.PI / n, d = "", u = .5 * c, p = 0; p < n; p += 1) {
            var f = u + p * c,
              m = Matter.Common.cos(f) * i,
              v = Matter.Common.sin(f) * i;
        ...
        }, o.fromVertices = function (e, t, n, o, d, u, p, f) {
          i || (i = s._requireGlobal("decomp", "poly-decomp"));
          var m, v, y, g, x, h, b, w, S;
          for (o = o || {}, v = [], d = void 0 !== d && d, u = void 0 !== u ? u : .01, p = void 0 !== p ? p : 10, f = void 0 !== f ? f : .01, i || s.warn("Bodies.fromVertices: poly-decomp.js required. Could not decompose vertices. Fallback to convex hull."), s.isArray(n[0]) || (n = [n]), w = 0; w < n.length; w += 1)
            if (g = n[w], (y = r.isConvex(g)) || !i) g = y ? r.clockwiseSort(g) : r.hull(g), v.push({
              position: {
                x: e,
                y: t
              },
              ...
              i.makeCCW(C), !1 !== u && i.removeCollinearPoints(C, u), !1 !== f && i.removeDuplicatePoints(C, f);
              var A = i.quickDecomp(C);
              for (x = 0; x < A.length; x++) {
                ...
                p > 0 && r.area(B) < p || v.push({
                  position: r.centre(B),
                  vertices: B
                })
              }
            } for (x = 0; x < v.length; x++) v[x] = a.create(s.extend(v[x], o));
          if (d) {
            for (x = 0; x < v.length; x++) {
              var M = v[x];
              for (h = x + 1; h < v.length; h++) {
                var k = v[h];
                if (l.overlaps(M.bounds, k.bounds)) {
                  var I = M.vertices,
                    _ = k.vertices;
                  for (b = 0; b < M.vertices.length; b++)
                    for (S = 0; S < k.vertices.length; S++) {
                      var T = c.magnitudeSquared(c.sub(I[(b + 1) % I.length], _[S])),
                        R = c.magnitudeSquared(c.sub(I[b], _[(S + 1) % _.length]));
                      T < 5 && R < 5 && (I[b].isInternal = !0, _[S].isInternal = !0)
                    }
                }
              }
            }
          }
          return v.length > 1 ? (m = a.create(s.extend({
            parts: v.slice(0)
          }, o)), a.setPosition(m, {
            x: e,
            y: t
    ...
    24: [function (e, t, n) {
      ...
      ! function () {
        o.fromVertices = function (e) {
          ...
          if (0 !== t)
            for (var n = Matter.Common.cos(t), o = Matter.Common.sin(t), i = 0; i < e.length; i++) {
              var r, s = e[i];
    ...
    27: [function (e, t, n) {
      ...
      ! function () {
        o.create = function (e, t) {
            ...
            return Matter.Common.sqrt(e.x * e.x + e.y * e.y)
          }, o.magnitudeSquared = function (e) {
            return e.x * e.x + e.y * e.y
          }, o.rotate = function (e, t, n) {
            var o = Matter.Common.cos(t),
              i = Matter.Common.sin(t);
            n || (n = {});
            var r = e.x * o - e.y * i;
          ...
          o.normalise = function (e) {
            ...
            return Matter.Common.atan2(t.y - e.y, t.x - e.x)
    ...
    28: [function (e, t, n) {
      ...
      ! function () {
        o.create = function (e, t) {
            ...
            return t ? n / 2 : Matter.Common.abs(n) / 2
          }, o.inertia = function (e, t) {
            for (var n, o, r = 0, s = 0, a = e, l = 0; l < a.length; l++) o = (l + 1) % a.length, n = Matter.Common.abs(i.cross(a[o], a[l])), r += n * (i.dot(a[o], a[o]) + i.dot(a[o], a[l]) + i.dot(a[l], a[l])), s += n;
            return t / 6 * (r / s)
          }, o.translate = function (e, t, n) {
            var o;
            if (n)
          ...
          o.rotate = function (e, t, n) {
            if (0 !== t) {
              for (var o = Matter.Common.cos(t), i = Matter.Common.sin(t), r = 0; r < e.length; r++) {
                var s = e[r],
                  a = s.x - n.x,
                  l = s.y - n.y;
            ...
            for (var a = [], l = 0; l < e.length; l++) {
              ...
              if (0 !== p) {
                var f = i.normalise({
                  ...
                  v = Matter.Common.sqrt(2 * Math.pow(p, 2)),
                ...
                for (var b = Matter.Common.acos(i.dot(f, m)), w = b / h, S = 0; S < h; S++) a.push(i.add(i.rotate(y, w * S), x))
              } else a.push(d)
            }
            return a
    ...
    29: [function (e, t, n) {
      ...
      o.Body = e("../body/Body"), o.Composite = e("../body/Composite"),
        ...
        o.World.addBody = o.Composite.addBody, o.World.addConstraint = o.Composite.addConstraint, o.World.clear = o.Composite.clear, o.Engine.run = o.Runner.run
    }, {
      "../body/Body": 1,
      "../body/Composite": 2,
      "../body/World": 3,
            ...
            for (var o = n, i = (e.engine, 0); i < t.length; i++) {
              ...
              if (r.render.visible) {
                ...
                var a = r.position.x - .5 * e.options.width,
                  ...
                  c = Matter.Common.abs(a) + Matter.Common.abs(l);
...
(function () {
  Matter.HypePlugin = {
    fromVerticesWithFallback: function (h, z, A, v, B, C, D, E, F, G, H) {
      var J = function (e, f) {
          if (null == e.parts || 1 > e.parts.length || 2 > e.parts.length) return !0;
          if (null != f)
            for (var c = I(f), d = 0; d < e.parts.length; d++) {
              for (var l = e.parts[d], t = !1, g = 0; g < c.length; g++)
                if (!0 == s(l.position, c[g])) {
                  t = !0;
                  break
                } if (!1 == t) return !1
            }
          if (2 > e.parts.length) return !0;
          c = [];
          for (d = 0; d < e.parts.length; d++) l = e.parts[d], l == e || 3 > l.vertices.length || c.push(I(l));
          a: {
                      ...
                      b: {
                        ...
                        for (var b = g[x], h = [
                          ...
                          var p = h[m],
                            ...
                            r = p[2],
                            q = p[3],
                            p = (q.y - r.y) * (n.x - k.x) - (q.x - r.x) * (n.y - k.y),
                            q = (q.x - r.x) * (k.y - r.y) - (q.y - r.y) * (k.x - r.x),
                            k = (n.x - k.x) * (k.y - r.y) - (n.y - k.y) * (k.x - r.x);
                          0 > p && (q = -q, k = -k, p = -p);
                          if (!0 == (0.005 < q -
                              0 && 0.005 < p - q && 0.005 < k - 0 && 0.005 < p - k)) {
                            a = !0;
                            break b
                          }
                        }
                        a = s(b[0], a) && s(b[1], a) && s(b[2], a) || s(a[0], b) && s(a[1], b) && s(a[2], b)
                      }
                      if (!0 == a) {
                        c = !1;
                        break a
        ...
        I = function (e) {
          for (var f = [], c = e.vertices[0], d = 0; d < e.vertices.length - 2; d++) f.push([c, e.vertices[d + 1], e.vertices[d + 2]]);
          return f
        },
        s = function (e, f) {
          var c = f[2].x - f[0].x,
            ...
            c = l * d - m * c;
          0 > c && (h = -h, g = -g, c = -c);
          return 0 <= h && 0 <= g && h + g <= c
        },
        m;
      if (!1 == F || !1 == H && !0 == G) m = Matter.Bodies.fromVertices(h,
        z, A, v, B, C, D, E);
      h = {
        x: h,
        y: z
      ...
      if (!0 == F) {
        var y, n, u;
        !0 == G && (u = Matter.Vertices.hull(A.slice(0)), n = Matter.Vertices.centre(u), y = Matter.Bodies.fromVertices(n.x, n.y, u, v, B, C, D, E));
        if (null == m || !1 == J(m, y)) !0 == window.HYPE_DEBUG_PHYSICS && !1 == H && console.log("error making concave shape for " + v.elementId + ", using convex hull"), m = y, vertices = u, h = n
      }
      return {
        physicsBody: m,
        centerPoint: h
